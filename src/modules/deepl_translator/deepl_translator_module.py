...
from src.modules.deepl_translator.selenium_deepl_translator import SeleniumDeeplTranslator


class DeeplTranslatorModule(ModuleInterface):
    def __init__(self, activated: bool, settings):
        ModuleInterface.__init__(self, activated=activated, settings=settings)
        self._translator = SeleniumDeeplTranslator()
